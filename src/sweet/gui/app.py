...
class Session(object):
    ...
    def __init__(self, app_name="sweet-gui"):
        ...
        context_list.toggled.connect(ctrl.on_context_item_toggled)
        ...
        ctrl.context_toggled.connect(context_list.on_context_toggled)
        ctrl.context_toggled.connect(stacked_request.on_context_toggled)
